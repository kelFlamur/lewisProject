...
import { updateEmail, updatePassword, updateFirstName, updateLastName, signup } from '../actions/user'
              ...
              <Block flex>
                ...
                <Block flex center>
                  ...
                  >
                    ...
                    <Block middle>
                      <Button color="primary" style={styles.createButton} onPress={this.handleSignUp}>
